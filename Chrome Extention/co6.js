...
request.addEventListener('load', function (e) {
  ...
  JSON.parse(this.responseText).data.forEach(function (el) {
    ...
    document.getElementById('pinterest').innerHTML = '<a href="http://pinterest.com/pin/create/button/?url=' + encodeURIComponent(el.links.self)  + '&media=' + imghost + el.multimedia[0]['@processed'].large.location +  '&description=' + el.attributes.summary_title + '" target="_blank"><img src="pinterest-5.svg" alt="Add to Pinterest"></a> ';
    ...
    document.getElementById('pix').innerHTML = '<a href="' + el.links.self + '"><img alt="" src="' + imghost + el.multimedia[0]['@processed'].medium.location + '"></a> ';
